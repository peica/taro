  ...
  return (
    (_temp = _class = class List extends PureComponent {
      ...
      constructor(props) {
        ...
        this._callOnScroll = memoizeOne((scrollDirection, scrollOffset, scrollUpdateWasRequested) =>
          this.props.onScroll({
            scrollDirection,
            scrollOffset,
      ...
      render() {
        ...
        const { isScrolling, scrollOffset, scrollUpdateWasRequested } = this.state // TODO Deprecate direction "horizontal"
